...
import com.e.attendance.activity.AddAttandanceSessionActivity;
import com.e.attendance.activity.MenuActivity;
		...
		login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(userrole.equals("admin"))
				{
					...
					{
						if(user_name.equals("shema") & pass_word.equals("admin123")){
