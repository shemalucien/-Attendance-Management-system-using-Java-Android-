package com.e.attendance.activity;
...
import com.e.attendance.R;
import com.e.attendance.activity.AddAttendanceActivity;
import com.e.attendance.activity.ViewAttendanceByFacultyActivity;
import com.e.attendance.bean.AttendanceSessionBean;
import com.e.attendance.bean.FacultyBean;
import com.e.attendance.bean.StudentBean;
import com.e.attendance.context.ApplicationContext;
import com.e.attendance.db.DBAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewAttendance.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ArrayList<com.e.attendance.bean.AttendanceBean> attendanceBeanList = dbAdapter.getAttendanceBySessionID(attendanceSessionBean);
		...
		viewTotalAttendance.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ArrayList<com.e.attendance.bean.AttendanceBean> attendanceBeanList = dbAdapter.getTotalAttendanceBySessionID(attendanceSessionBean);
				((ApplicationContext)AddAttandanceSessionActivity.this.getApplicationContext()).setAttendanceBeanList(attendanceBeanList);
